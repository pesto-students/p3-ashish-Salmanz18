//todo: Using Async/Await and Generators, create separate functions and achieve the same functionality.
//todo: Execute 3 callback functions asynchronously, for example doTask1(), doTask2() and doTask3().
